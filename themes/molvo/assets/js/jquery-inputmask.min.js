        ...
        (r =
          ...
          typeof (n = function (re, oe, se) {
            ...
            function he(e, t, V) {
              ...
              var d = function e(t, i, n, a, r) {
                ...
                do {
                  if (t === true && K().validPositions[u]) {
                    c =
                      r &&
                      K().validPositions[u].match.optionality === true &&
                      K().validPositions[u + 1] === se &&
                      (K().validPositions[u].generatedInput === true ||
                        (K().validPositions[u].input ==
                          V.skipOptionalPartCharacter &&
                          u > 0))
                        ? h(u, E(u, l, u - 1))
                        : K().validPositions[u];
                    f = c.match;
                    l = c.locator.slice();
                    s.push(
                      n === true ? c.input : n === false ? f.nativeDef : L(u, f)
                    );
                  } else {
                    c = b(u, l, u - 1);
                    f = c.match;
                    ...
                    if (
                      d === false ||
                      d === se ||
                      (typeof d === "number" && isFinite(d) && d > u)
                    ) {
                  ...
                  ((k === se || u < k) && (f.fn !== null || f.def !== "")) ||
                  i > u
                );
                if (s[s.length - 1] === "") {
                  s.pop();
                }
                if (n !== false || K().maskLength === se)
                  K().maskLength = u - 1;
                V.greedy = o;
                return s;
              };
              ...
              function b(e, t, i) {
                return (
                  K().validPositions[e] || h(e, E(e, t ? t.slice() : t, i))
                );
              }
              function A(e, t) {
                  ...
                  function T(e, t, i) {
                        ...
                        re.each(
                          ...
                          function (e, t) {
                            ...
                            var i = r !== se ? r : t.alternation,
                              n =
                                t.locator[i] !== se
                                  ? t.locator[i].toString().indexOf(a)
                                  : -1;
                            if ((s === se || n < s) && n !== -1) {
                              o = t;
                              s = n;
                    ...
                    function o(e, t) {
                      var i = e.locator.slice(e.alternation).join(""),
                        ...
                        a = i == n;
                      a =
                        a && e.match.fn === null && t.match.fn !== null
                          ? t.match.fn.test(
                              e.match.def,
                              K(),
                              N,
                      ...
                      if (
                        ...
                        (e.alternation === t.alternation &&
                          e.locator[e.alternation]
                            .toString()
                            .indexOf(t.locator[t.alternation]) === -1)
                      ) {
                        e.mloc = e.mloc || {};
                      ...
                      if (e.isGroup && i !== e) {
                        ...
                        if (m === -1 || typeof m === "string") {
                          ...
                          if (K().excludes[N]) {
                            var y = v.slice();
                            for (
                              var b = 0, x = K().excludes[N].length;
                              b < x;
                              b++
                            ) {
                              v.splice(
                                v.indexOf(K().excludes[N][b].toString()),
                                1
                              );
                            }
                            if (v.length === 0) {
                          ...
                          if (
                            V.keepStatic === true ||
                            (isFinite(parseInt(V.keepStatic)) &&
                              h >= V.keepStatic)
                          )
                            v = v.slice(0, 1);
                          var P = false;
                          ...
                          e = T(u.matches[m] || j.matches[m], [m].concat(t), i);
                        if (e) return true;
                      } else if (
                        e.isQuantifier &&
                        i !== j.matches[re.inArray(e, j.matches) - 1]
                      ) {
                        var D = e;
                        for (
                          var M = F.length > 0 ? F.shift() : 0;
                          M <
                            (isNaN(D.quantifier.max)
                              ? M + 1
                              : D.quantifier.max) && R <= N;
                          M++
                        ) {
                        ...
                        if (t.def !== "") {
                          if (n.length === 0) n = t.locator.slice();
                            ...
                            for (var i = 0; i < n.length; i++) {
                              if (
                                t.locator[i] &&
                                n[i].toString().indexOf(t.locator[i]) === -1
                              ) {
                                n[i] += "," + t.locator[i];
                              }
                            }
                ...
                if (N > -1) {
                  if (e === se) {
                    var r = N - 1,
                      o;
                    while (
                      (o = K().validPositions[r] || K().tests[r]) === se &&
                      r > -1
                    ) {
                      r--;
                    }
              ...
              function M(e, t, i) {
                switch (V.casing || t.casing) {
                  ...
                  case "title":
                    ...
                    if (
                      i === 0 ||
                      (n && n.input === String.fromCharCode(de.keyCode.SPACE))
                    ) {
                      e = e.toUpperCase();
                    } else {
                      e = e.toLowerCase();
                ...
                if (m === -1 && a === se) {
                  ...
                  for (; m >= 0; m--) {
                    ...
                    if (u && u.alternation !== se) {
                      if (
                        f &&
                        f.locator[u.alternation] !== u.locator[u.alternation]
                      ) {
                        break;
                      }
                      o = m;
              ...
              function F(u, e, t, f, i, n) {
                ...
                function r(r, o, s) {
                  ...
                  re.each(E(r), function (e, t) {
                    ...
                    l =
                      i.fn != null
                        ? i.fn.test(o, K(), r, s, V, c(u))
                        : (o === i.def || o === V.skipOptionalPartCharacter) &&
                          i.def !== ""
                        ? { c: L(r, i, true) || i.def, pos: r }
                        : false;
                    if (l !== false) {
                      var n = l.c !== se ? l.c : o,
                        a = r;
                      n =
                        n === V.skipOptionalPartCharacter && i.fn === null
                          ? L(r, i, true) || i.def
                          : n;
                      if (l.remove !== se) {
                      ...
                      if (
                        !N(u, re.extend({}, t, { input: M(n, i, a) }), f, a)
                      ) {
                        l = false;
                      }
                      return false;
                  ...
                  if (k === se || a < k) {
                    ...
                    if ((!t || f === true) && o === false && n !== true) {
                      ...
                      if (
                        l &&
                        l.match.fn === null &&
                        (l.match.def === e || e === V.skipOptionalPartCharacter)
                      ) {
                        o = { caret: G(a) };
                      } else {
                        if (
                          (V.insertMode || K().validPositions[G(a)] === se) &&
                          (!R(a, true) || K().jitOffset[a])
                        ) {
                          if (
                            K().jitOffset[a] &&
                            K().validPositions[G(a)] === se
                          ) {
                ...
                if (
                  re.isFunction(V.postValidation) &&
                  o !== false &&
                  !t &&
                  f !== true &&
                  n !== true
                ) {
                  var m = V.postValidation(
                    C(true),
                    u.begin !== se ? (g ? u.end : u.begin) : u,
                    o,
                    V
                  );
                  if (m !== se) {
              ...
              function N(e, t, i, n) {
                function a(e, t, i) {
                  ...
                  if (
                    n !== se &&
                    ((n.match.fn === null && n.match.optionality !== true) ||
                      n.input === V.radixPoint)
                  ) {
                    var a =
                        i.begin <= e - 1
                          ? t[e - 1] && t[e - 1].match.fn === null && t[e - 1]
                          : t[e - 1],
                      r =
                        i.end > e + 1
                          ? t[e + 1] && t[e + 1].match.fn === null && t[e + 1]
                ...
                if (
                  r !== o ||
                  (V.insertMode && K().validPositions[n] !== se && i === se)
                ) {
                  ...
                  for (u = l; u >= r; u--) {
                    if (
                      K().validPositions[u] &&
                      K().validPositions[u].match.nativeDef === "+"
                    ) {
                      V.isNegative = false;
                    }
                    ...
                    if (
                      ...
                      while (A(m).match.def !== "") {
                        if (
                          d === false &&
                          s[m] &&
                          s[m].match.nativeDef === h.match.nativeDef
                        ) {
                        ...
                        if (
                          ...
                          m > o &&
                          R(m, true) &&
                          (h.match.fn !== null || m > K().maskLength)
                        ) {
                          break;
                        }
                        m++;
              ...
              function G(e, t) {
                ...
                while (
                  A(i).match.def !== "" &&
                  ((t === true &&
                    (A(i).match.newBlockMarker !== true || !R(i))) ||
                    (t !== true && !R(i)))
                ) {
                  i++;
                }
              ...
              function I(e, t) {
                ...
                while (
                  --i > 0 &&
                  ((t === true && A(i).match.newBlockMarker !== true) ||
                    (t !== true &&
                      !R(i) &&
                      ((n = E(i)),
                      n.length < 2 ||
                        (n.length === 2 && n[1].match.def === ""))))
                ) {}
                return i;
              }
              ...
              function L(e, t, i) {
                ...
                if (t.placeholder !== se || i === true) {
                  return re.isFunction(t.placeholder)
                    ? t.placeholder(V)
                    : t.placeholder;
                } else if (t.fn === null) {
                  if (e > -1 && K().validPositions[e] === se) {
                    ...
                    if (
                      ...
                      for (var o = 0; o < n.length; o++) {
                        if (
                          n[o].match.optionality !== true &&
                          n[o].match.optionalQuantifier !== true &&
                          (n[o].match.fn === null ||
                            r === se ||
                            n[o].match.fn.test(r.match.def, K(), e, true, V) !==
                              false)
                        ) {
                          a.push(n[o]);
              ...
              var U = {
                keydownEvent: function e(t) {
                  var i = this,
                    ...
                    r = W(i);
                  if (
                    a === de.keyCode.BACKSPACE ||
                    a === de.keyCode.DELETE ||
                    (pe && a === de.keyCode.BACKSPACE_SAFARI) ||
                    (t.ctrlKey && a === de.keyCode.X && !me("cut"))
                  ) {
                    t.preventDefault();
                    Z(i, a, r);
                    B(
                    ...
                    a === de.keyCode.END ||
                    a === de.keyCode.PAGE_DOWN
                  ) {
                    t.preventDefault();
                    var o = G(S());
                    W(i, t.shiftKey ? r.begin : o, o, true);
                  } else if (
                    (a === de.keyCode.HOME && !t.shiftKey) ||
                    a === de.keyCode.PAGE_UP
                  ) {
                    t.preventDefault();
                    W(i, 0, t.shiftKey ? r.begin : 0, true);
                  } else if (
                    ((V.undoOnEscape && a === de.keyCode.ESCAPE) ||
                      (a === 90 && t.ctrlKey)) &&
                    t.altKey !== true
                  ) {
                  ...
                  if (
                    ...
                    if (l) {
                      if (
                        ...
                        l = V.radixPoint.charCodeAt(0);
                      var u = i ? { begin: r, end: r } : W(o),
                        f,
                      ...
                      if (m !== false) {
                        ...
                        f =
                          m.caret !== se
                            ? m.caret
                            : G(m.pos.begin ? m.pos.begin : m.pos);
                        K().p = f;
                      }
                ...
                pasteEvent: function e(t) {
                  ...
                  if (
                    l === (g ? _().reverse() : _()).slice(0, o.begin).join("")
                  )
                    l = "";
                  if (u === (g ? _().reverse() : _()).slice(o.end).join(""))
                    u = "";
                  ...
                  if (C().join("") !== r) {
                    ...
                    if (C().join("") !== r) {
                      ...
                      var d = o,
                        ...
                        h = false;
                      if (u !== c) {
                        var g = (h = u.length >= c.length)
                            ? u.length
                            : c.length,
                          v;
                        for (
                          v = 0;
                          u.charAt(v) === c.charAt(v) && v < g;
                          v++
                        ) {}
                        if (h) {
                          d.begin = v - l;
                        ...
                        if (f.length > p.length) {
                          ...
                          if (f.length < p.length) {
                            ...
                            if (
                              ...
                              V.radixPoint !== "" &&
                              f === "" &&
                              u.charAt(d.begin + l - 1) === V.radixPoint
                            ) {
                              d.begin--;
                              m = V.radixPoint;
                            }
                      ...
                      B(a, C(), { begin: d.begin + l, end: d.end + l });
                      if (m.length > 0) {
                        ...
                        k.keyCode = V.numericInput
                          ? de.keyCode.BACKSPACE
                          : de.keyCode.DELETE;
                ...
                setValueEvent: function e(t) {
                  ...
                  if (re.isFunction(V.onBeforeMask))
                    n = V.onBeforeMask.call(c, n, V) || n;
                  n = n.toString().split("");
                  z(i, true, false, n);
                  v = C().join("");
                  if (
                    (V.clearMaskOnLostFocus || V.clearIncomplete) &&
                    i.inputmask._valueGet() === _().join("")
                  ) {
                          ...
                          default:
                            ...
                            if (i < a) {
                              ...
                              if (
                                (s !== "" &&
                                  C()[a] !== s &&
                                  o.match.optionalQuantifier !== true &&
                                  o.match.newBlockMarker !== true) ||
                                (!R(a, V.keepStatic) && o.match.def === s)
                              ) {
                                var l = G(a);
                                if (i >= l || i === a) {
                                  a = l;
                ...
                cutEvent: function e(t) {
                  ...
                  var o = oe.clipboardData || r.clipboardData,
                    s = g
                      ? C().slice(a.end, a.begin)
                      : C().slice(a.begin, a.end);
              ...
              function z(a, e, r, t, i) {
                ...
                function c(e, t) {
                  ...
                  return (
                    i !== -1 &&
                    !R(e) &&
                    (A(e).match.nativeDef === t.charAt(0) ||
                      (A(e).match.fn === null &&
                        A(e).match.nativeDef === "'" + t.charAt(0)) ||
                      (A(e).match.nativeDef === " " &&
                        (A(e + 1).match.nativeDef === t.charAt(0) ||
                          (A(e + 1).match.fn === null &&
                            A(e + 1).match.nativeDef === "'" + t.charAt(0)))))
                  );
                }
                ...
                if (!r && V.autoUnmask !== true) {
                  var n = _().slice(0, G(-1)).join(""),
                    p = s
                      .join("")
                      .match(new RegExp("^" + de.escapeRegex(n), "g"));
                  if (p && p.length > 0) {
                ...
                re.each(s, function (e, t) {
                  if (t !== se) {
                    if (
                      K().validPositions[e] === se &&
                      s[e] === L(e) &&
                      R(e, true) &&
                      F(e, s[e], true, se, se, true) === false
                    ) {
                      K().p++;
                    } else {
                ...
                if (e)
                  B(
                    a,
                    C(),
                    f ? f.forwardPosition : se,
                    i || new re.Event("checkval"),
                    i && i.type === "input"
                  );
              }
              function i(e) {
              ...
              function W(e, t, i, n) {
                ...
                if (t !== se) {
                  ...
                  if (typeof t === "number") {
                    ...
                    var o =
                      parseInt(
                        ((e.ownerDocument.defaultView || oe).getComputedStyle
                          ? (
                              e.ownerDocument.defaultView || oe
                  ...
                  return { begin: n ? t : a(t), end: n ? i : a(i) };
                }
              }
              function q(e) {
                ...
                var u =
                  o && o.alternation !== se ? o.locator[o.alternation] : se;
                for (n = i - 1; n > a; n--) {
                  l = r[n];
                  if (
                    (l.match.optionality ||
                      ...
                      (u &&
                        ((u !== r[n].locator[o.alternation] &&
                          l.match.fn != null) ||
                          (l.match.fn === null &&
                            l.locator[o.alternation] &&
                            O(
                              l.locator[o.alternation].toString().split(","),
                              u.toString().split(",")
                            ) &&
                            E(n)[0].def !== "")))) &&
                    t[n] === L(n, l.match)
                ...
                return e ? { l: i, def: r[i] ? r[i].match : se } : i;
              }
              function Q(e) {
                e.length = 0;
              ...
              function $(e) {
                ...
                if (
                  ...
                  for (var a = 0; a <= n; a++) {
                    ...
                    if (
                      (r.fn !== null &&
                        K().validPositions[a] === se &&
                        r.optionality !== true &&
                        r.optionalQuantifier !== true) ||
                      (r.fn === null && e[a] !== L(a, r))
                    ) {
                      t = false;
                      break;
              ...
              function Z(e, t, i, n, a) {
                ...
                if (t === de.keyCode.BACKSPACE && i.end - i.begin < 1) {
                  i.begin = I(i.begin);
                  if (
                    K().validPositions[i.begin] !== se &&
                    K().validPositions[i.begin].input === V.groupSeparator
                  ) {
                    i.begin--;
                  }
                  ...
                  i.end =
                    R(i.end, true) &&
                    K().validPositions[i.end] &&
                    K().validPositions[i.end].input !== V.radixPoint
                      ? i.end + 1
                      : G(i.end) + 1;
                  if (
                    K().validPositions[i.begin] !== se &&
                  ...
                  if (o) {
                    var s =
                      o.caret !== se
                        ? o.caret
                        : o.pos
                        ? G(o.pos.begin ? o.pos.begin : o.pos)
                        : S(-1, true);
              ...
              function J(u) {
                var f = (u.ownerDocument.defaultView || oe).getComputedStyle(
                  u,
                  null
                );
                function t(e) {
                ...
                function f() {
                  if (le.activeElement === e) {
                    n.splice(
                      t.begin,
                      0,
                      t.begin === t.end || t.end > K().maskLength
                    ...
                    do {
                      if (K().validPositions[l]) {
                        ...
                        if (
                          V.jitMasking === false ||
                          l < p ||
                          (typeof V.jitMasking === "number" &&
                            isFinite(V.jitMasking) &&
                            V.jitMasking > l)
                        ) {
                          u(L(l, r));
                        } else a = false;
              ...
              function n(e) {
                function t(e, l) {
                  function t(e) {
                    ...
                    function n(e) {
                      if (
                        re.valHooks &&
                        (re.valHooks[e] === se ||
                          re.valHooks[e].inputmaskpatch !== true)
                      ) {
                        var n =
                          re.valHooks[e] && re.valHooks[e].get
                            ? re.valHooks[e].get
                            : function (e) {
                                return e.value;
                              };
                        var r =
                          re.valHooks[e] && re.valHooks[e].set
                            ? re.valHooks[e].set
                            : function (e, t) {
                                e.value = t;
                                return e;
                    ...
                    function a() {
                      if (this.inputmask) {
                        return this.inputmask.opts.autoUnmask
                          ...
                          : S() !== -1 || l.nullable !== true
                          ? le.activeElement === this && l.clearMaskOnLostFocus
                            ? (g
                                ? Q(C().slice()).reverse()
                                : Q(C().slice())
                              ).join("")
                  ...
                  var n =
                    (e.tagName === "INPUT" &&
                      re.inArray(i, l.supportsInputType) !== -1) ||
                    e.isContentEditable ||
                    e.tagName === "TEXTAREA";
                  if (!n) {
                    if (e.tagName === "INPUT") {
                ...
                if (i !== false) {
                  ...
                  v = _().join("");
                  if (
                    u.inputmask._valueGet(true) !== "" ||
                    V.clearMaskOnLostFocus === false ||
                    le.activeElement === u
                  ) {
                    var n = re.isFunction(V.onBeforeMask)
                      ? V.onBeforeMask.call(
                          c,
                          u.inputmask._valueGet(true),
                          V
                    ...
                    if (
                      V.clearMaskOnLostFocus === false ||
                      (V.showMaskOnFocus && le.activeElement === u) ||
                      u.inputmask._valueGet(true) !== ""
                    )
                      B(u, a);
                ...
                switch (e.action) {
                  ...
                  case "unmaskedvalue":
                    if (u === se || e.value !== se) {
                      X = e.value;
                      X = (
                        re.isFunction(V.onBeforeMask)
                          ? V.onBeforeMask.call(c, X, V) || X
                          : X
                      ).split("");
                      z.call(this, se, false, false, X);
                      if (re.isFunction(V.onBeforeWrite))
                        V.onBeforeWrite.call(c, se, C(), 0, V);
                    }
                    return i(u);
                  case "mask":
                    n(u);
                  ...
                  case "format":
                    X = (
                      re.isFunction(V.onBeforeMask)
                        ? V.onBeforeMask.call(c, e.value, V) || e.value
                        : e.value
                    ).split("");
                  ...
                  case "remove":
                    if (u && u.inputmask) {
                      ...
                      r = re(u);
                      u.inputmask._valueSet(
                        V.autoUnmask ? i(u) : u.inputmask._valueGet(true)
                      );
                      H.off(u);
              ...
              (de.prototype = {
                ...
                defaults: {
                  ...
                  onBeforePaste: function (e, t) {
                    return re.isFunction(t.onBeforeMask)
                  ...
                  return (
                    ...
                    re.each(e, function (e, t) {
                      ...
                      !(function (i, e, n, a) {
                        ...
                        t,
                        n,
                        re.extend(!0, {}, a.userOptions),
                        a.dataAttribute
                      ) ||
                        ((i = r(n, a.noMasksCache)) !== se &&
                          (t.inputmask !== se &&
                            ((t.inputmask.opts.autoUnmask = !0),
                            t.inputmask.remove()),
                          (t.inputmask = new de(se, se, !0)),
                          (t.inputmask.opts = n),
                          (t.inputmask.noMasksCache = a.noMasksCache),
                          (t.inputmask.userOptions = re.extend(
                            !0,
                            {},
                            a.userOptions
                          )),
                          ...
                          he.call(t.inputmask, { action: "mask" })));
                    }),
                ...
                unmaskedvalue: function (e) {
                  return (
                    ...
                    he.call(this, { action: "unmaskedvalue", value: e })
                  );
                },
                remove: function () {
                  return he.call(this, { action: "remove" });
                },
                getemptymask: function () {
                  return (
                    (this.maskset =
                      this.maskset || r(this.opts, this.noMasksCache)),
                    he.call(this, { action: "getemptymask" })
                  );
                },
                ...
                isComplete: function () {
                  return (
                    (this.maskset =
                      this.maskset || r(this.opts, this.noMasksCache)),
                    he.call(this, { action: "isComplete" })
                  );
                },
                getmetadata: function () {
                  return (
                    (this.maskset =
                      this.maskset || r(this.opts, this.noMasksCache)),
                    he.call(this, { action: "getmetadata" })
                  );
                },
                isValid: function (e) {
                  return (
                    (this.maskset =
                      this.maskset || r(this.opts, this.noMasksCache)),
                    he.call(this, { action: "isValid", value: e })
                  );
                },
                format: function (e, t) {
                  return (
                    (this.maskset =
                      this.maskset || r(this.opts, this.noMasksCache)),
                    he.call(this, { action: "format", value: e, metadata: t })
                  );
                },
                setValue: function (e) {
                ...
                analyseMask: function (e, r, o) {
                            ...
                            re.each(e.split(""), function (e, t) {
                              (a = i.matches[n - 1]),
                                i.matches.splice(n++, 0, {
                                  ...
                                  placeholder:
                                    o.staticDefinitionSymbol !== se ? t : se,
                                  nativeDef: (l ? "'" : "") + t,
                                });
                            })),
                        (l = !1))
                      : (t =
                          (o.definitions ? o.definitions[e] : se) ||
                          de.prototype.definitions[e]) && !l
                      ? i.matches.splice(n++, 0, {
                          fn: t.validator
                    ...
                    if (0 < f.length) {
                      if ((d((i = f[f.length - 1]), v), i.isAlternator)) {
                        ...
                        for (var e = 0; e < n.matches.length; e++)
                          n.matches[e].isGroup && (n.matches[e].isGroup = !1);
                        0 < f.length
                          ? (i = f[f.length - 1]).matches.push(n)
                          : u.matches.push(n);
                      }
                    } else d(u, v);
                  }
                  ...
                  for (
                    r &&
                    ((o.optionalmarker[0] = se), (o.optionalmarker[1] = se));
                    (A = r ? s.exec(e) : a.exec(e));
                      ...
                      switch (v.charAt(0)) {
                        ...
                        case o.groupmarker[1]:
                          if ((((t = f.pop()).openGroup = !1), t !== se))
                            if (0 < f.length) {
                              if (
                                ((i = f[f.length - 1]).matches.push(t),
                                i.isAlternator)
                              ) {
                                n = f.pop();
                                for (var g = 0; g < n.matches.length; g++)
                                  (n.matches[g].isGroup = !1),
                                    (n.matches[g].alternatorGroup = !1);
                                0 < f.length
                                  ? (i = f[f.length - 1]).matches.push(n)
                                  : u.matches.push(n);
                              }
                          ...
                          var v,
                            ...
                            P =
                              1 === b.length
                                ...
                                : parseInt(b[1]);
                          ("*" !== x && "+" !== x) || (x = "*" === P ? 0 : 1),
                            (k.quantifier = { min: x, max: P, jit: y[1] });
                          var S,
                            w,
                            A,
                            E =
                              0 < f.length
                                ? f[f.length - 1].matches
                                : u.matches;
                          (A = E.pop()).isAlternator &&
                            (E.push(A),
                            (E = A.matches),
                            (S = new p(!0)),
                            (w = E.pop()),
                            ...
                            0 < f.length
                              ? ((_ = (i = f[f.length - 1]).matches[
                                ...
                                (_.matches === se ||
                                  ...
                                  ? f.pop()
                                  : M(i.matches))
                              : M(u.matches)).isAlternator
                            ? f.push(C)
                            : (C.alternatorGroup
                                ? ((n = f.pop()), (C.alternatorGroup = !1))
                                : (n = new p(!1, !1, !1, !0)),
                              n.matches.push(C),
                              f.push(n),
                              C.openGroup &&
                        ...
                        a &&
                          ...
                          re.each(a.matches, function (e, t) {
                            ...
                            (i === se ||
                              ...
                              ((t.isGroup = !1),
                              r ||
                                (d(t, o.groupmarker[0], 0),
                                !0 !== t.openGroup && d(t, o.groupmarker[1]))),
                              n(t);
                          });
                      })(u),
                      c.push(u)),
                      ...
                      (function e(t) {
                        ...
                        t.matches)) {
                          ...
                          t.matches.hasOwnProperty(i) &&
                            ...
                            t.matches[i].matches !== se
                              ? (t.matches[i] = e(t.matches[i]))
                              : (t.matches[i] =
                                  ((r = t.matches[i]) === o.optionalmarker[0]
                                    ? (r = o.optionalmarker[1])
                                    : r === o.optionalmarker[1]
                                    ? (r = o.optionalmarker[0])
                                    : r === o.groupmarker[0]
                                    ? (r = o.groupmarker[1])
                                    : r === o.groupmarker[1] &&
                                      (r = o.groupmarker[0]),
            ...
            function c(e, t, r) {
              ...
              function u(e) {
                ...
                if (t != e) {
                  ...
                  t =
                    i +
                    (i < n.slice(0, i.length)
                      ? n.slice(i.length)
                      : i > a.slice(0, i.length)
                      ? a.slice(i.length)
                      : t.toString().slice(i.length));
                }
                return t;
              }
              function f(e, t, i) {
                ...
                e["raw" + o] = t;
                if (s !== undefined)
                  s.call(e.date, o == "month" ? parseInt(e[o]) - 1 : e[o]);
              }
              if (typeof n === "string") {
                while ((a = d(r).exec(t))) {
                ...
                n &&
                (typeof n === "undefined" ? "undefined" : m(n)) === "object" &&
            ...
            return (
              s.extendAliases({
                datetime: {
                  mask: function (e) {
                    return (
                      (p.S = e.i18n.ordinalSuffix.join("|")),
                      (e.inputFormat = t[e.inputFormat] || e.inputFormat),
                      (e.displayFormat =
                        t[e.displayFormat] || e.displayFormat || e.inputFormat),
                      (e.outputFormat =
                        t[e.outputFormat] || e.outputFormat || e.inputFormat),
                      (e.placeholder =
                        "" !== e.placeholder
                          ? e.placeholder
                  ...
                  postValidation: function (e, t, i, n) {
                    (n.min = c(n.min, n.inputFormat, n)),
                      (n.max = c(n.max, n.inputFormat, n));
                    var a,
                      r,
                      o = i,
                              ...
                              t.min &&
                                ...
                                e.year === e.rawyear &&
                                  t.min.date.getTime() ==
                                    t.min.date.getTime() &&
                                  (i =
                                    t.min.date.getTime() <= e.date.getTime()));
                            }
                            i &&
                              t.max &&
                  ...
                  onKeyDown: function (e, t, i, n) {
                    if (e.ctrlKey && e.keyCode === s.keyCode.RIGHT) {
                      for (
                        var a, r = new Date(), o = "";
                        (a = d(n).exec(n.inputFormat));

                      )
                        "d" === a[0].charAt(0)
                          ? (o += f(r.getDate(), a[0].length))
                          : "m" === a[0].charAt(0)
                          ? (o += f(r.getMonth() + 1, a[0].length))
                          : "yyyy" === a[0]
                          ? (o += r.getFullYear().toString())
                          : "y" === a[0].charAt(0) &&
                            (o += f(r.getYear(), a[0].length));
          ...
          typeof (n = function (b) {
            ...
            function o(e, t) {
              ...
              for (var n = 0; n < e.length; n++) {
                if (
                  b.prototype.definitions[e.charAt(n)] ||
                  t.definitions[e.charAt(n)] ||
                  t.optionalmarker.start === e.charAt(n) ||
                  t.optionalmarker.end === e.charAt(n) ||
                  t.quantifiermarker.start === e.charAt(n) ||
                  t.quantifiermarker.end === e.charAt(n) ||
                  t.groupmarker.start === e.charAt(n) ||
                  t.groupmarker.end === e.charAt(n) ||
            ...
            function e(e, t, i) {
              if (0 < t) {
                var n = x.inArray(i.radixPoint, e);
              ...
              b.extendAliases({
                numeric: {
                  mask: function (e) {
                    ...
                    0 !== e.repeat &&
                      ...
                      e.autoGroup &&
                        ...
                        isFinite(e.integerDigits) &&
                          ((t = Math.floor(e.integerDigits / e.groupSize)),
                    ...
                    return (
                      ...
                      !0 === e.integerOptional
                        ...
                        : (r += "~{" + e.integerDigits + "}"),
                      void 0 !== e.digits &&
                        ((n = e.decimalProtect ? ":" : e.radixPoint),
                  ...
                  preValidation: function (e, t, i, n, a, r) {
                    if ("-" === i || i === a.negationSymbol.front)
                      return (
                        !0 === a.allowMinus &&
                        ((a.isNegative =
                          void 0 === a.isNegative || !a.isNegative),
                        "" === e.join("") || {
                    ...
                    if (
                      ...
                      if (-1 !== o && void 0 !== r.validPositions[o])
                        return !0 === a.numericInput
                          ? t === o
                          : { caret: o + 1 };
                    }
                    return !0;
                  ...
                  postValidation: function (e, t, i, n) {
                    ...
                    var o = void 0 !== i.caret ? i.caret : i.pos,
                      s = e.slice();
                    n.numericInput &&
                      ((o = s.length - o - 1), (s = s.reverse()));
                    var l = s[o];
                    if (
                      (l === n.groupSeparator && (l = s[(o += 1)]),
                      o === s.length - n.suffix.length - 1 &&
                        l === n.radixPoint)
                    )
                      return i;
                    void 0 !== l &&
                      l !== n.radixPoint &&
                      l !== n.negationSymbol.front &&
                      l !== n.negationSymbol.back &&
                      ((s[o] = "?"),
                      0 < n.prefix.length &&
                      o >= (!1 === n.isNegative ? 1 : 0) &&
                      o < n.prefix.length - 1 + (!1 === n.isNegative ? 1 : 0)
                        ? (r[o - (!1 === n.isNegative ? 1 : 0)] = "?")
                        : 0 < n.suffix.length &&
                          o >=
                            s.length -
                              n.suffix.length -
                    ...
                    var u,
                      ...
                      h = s.join("").replace(r, "");
                    if (
                      ((h = (h = (h = (h = h.replace(a, "")).replace(
                        new RegExp(b.escapeRegex(n.groupSeparator), "g"),
                        ""
                      )).replace(
                        new RegExp(
                          "[-" + b.escapeRegex(n.negationSymbol.front) + "]",
                          "g"
                        ),
                        ""
                      )).replace(
                        new RegExp(b.escapeRegex(n.negationSymbol.back) + "$"),
                        ""
                      )),
                      isNaN(n.placeholder) &&
                        (h = h.replace(
                          new RegExp(b.escapeRegex(n.placeholder), "g"),
                          ""
                        )),
                      1 < h.length &&
                        1 !== h.indexOf(n.radixPoint) &&
                        ("0" === l && (h = h.replace(/^\?/g, "")),
                        (h = h.replace(/^0/g, ""))),
                      h.charAt(0) === n.radixPoint &&
                        "" !== n.radixPoint &&
                        !0 !== n.numericInput &&
                        (h = "0" + h),
                      "" !== h)
                      ...
                      if (
                        ((h = h.split("")),
                        (!n.digitsOptional ||
                          (n.enforceDigitsOnBlur && "blur" === i.event)) &&
                          isFinite(n.digits))
                      ) {
                        var g = x.inArray(n.radixPoint, h),
                          v = x.inArray(n.radixPoint, s);
                        -1 === g && (h.push(n.radixPoint), (g = h.length - 1));
                        for (var k = 1; k <= n.digits; k++)
                          (n.digitsOptional &&
                            (!n.enforceDigitsOnBlur || "blur" !== i.event)) ||
                          (void 0 !== h[g + k] &&
                            h[g + k] !== n.placeholder.charAt(0))
                            ? -1 !== v &&
                              void 0 !== s[v + k] &&
                              (h[g + k] = h[g + k] || s[v + k])
                            : (h[g + k] =
                                i.placeholder || n.placeholder.charAt(0));
                      }
                      !0 !== n.autoGroup ||
                      "" === n.groupSeparator ||
                      (l === n.radixPoint && void 0 === i.pos && !i.dopost)
                        ? (h = h.join(""))
                        : ((u =
                            h[h.length - 1] === n.radixPoint &&
                            i.c === n.radixPoint),
                          (h = b(
                            ((f = h),
                            (d = ""),
                          ...
                          u && (h += n.radixPoint),
                          h.charAt(0) === n.groupSeparator && h.substr(1));
                    }
                    n.isNegative &&
                      "blur" === i.event &&
                      (n.isNegative = "0" !== h),
                      ...
                      (h += a),
                      n.isNegative &&
                        ((h = n.negationSymbol.front + h),
                        (h += n.negationSymbol.back)),
                      (h = h.split("")),
                      void 0 !== l &&
                        (l !== n.radixPoint &&
                        l !== n.negationSymbol.front &&
                        l !== n.negationSymbol.back
                          ...
                          : (l !== n.radixPoint &&
                              l !== n.negationSymbol.front &&
                              l !== n.negationSymbol.back) ||
                            (-1 !== (m = x.inArray(l, h)) && (o = m))),
                      n.numericInput &&
                        ((o = h.length - o - 1), (h = h.reverse()));
                    var y = {
                      caret:
                        (void 0 !== l && void 0 === i.pos) || void 0 === o
                          ? o
                          : o + (n.numericInput ? -1 : 1),
                      buffer: h,
                    ...
                    if (e)
                      switch (e.type) {
                        ...
                        case "checkval":
                          var a;
                          if (
                            (void 0 === (r = n).parseMinMaxOptions &&
                              (null !== r.min &&
                                ((r.min = r.min
                                  .toString()
                                  .replace(
                                    new RegExp(
                                      b.escapeRegex(r.groupSeparator),
                                      "g"
                                    ),
                                    ""
                                  )),
                            ...
                            null !== n.min || null !== n.max)
                          ) {
                            if (
                              ((a = n.onUnMask(
                                t.join(""),
                                void 0,
                                x.extend({}, n, { unmaskAsNumber: !0 })
                              )),
                              null !== n.min && a < n.min)
                            )
                              return (
                                (n.isNegative = n.min < 0),
                                n.postValidation(
                                  n.min
                                    .toString()
                            ...
                            if (null !== n.max && a > n.max)
                              return (
                                (n.isNegative = n.max < 0),
                                n.postValidation(
                                  n.max
                                    .toString()
                                    .replace(".", n.radixPoint)
                  ...
                  regex: {
                    integerPart: function (e, t) {
                      return t
                        ? new RegExp(
                            "[" + b.escapeRegex(e.negationSymbol.front) + "+]?"
                          )
                        : new RegExp(
                            "[" +
                              b.escapeRegex(e.negationSymbol.front) +
                    ...
                    integerNPart: function (e) {
                      return new RegExp(
                        "[\\d" +
                          b.escapeRegex(e.groupSeparator) +
                          b.escapeRegex(e.placeholder.charAt(0)) +
                          "]+"
                      );
                    },
                  },
                  definitions: {
                    "~": {
                      validator: function (e, t, i, n, a, r) {
                        ...
                        if ("k" === e || "m" === e) {
                          o = { insert: [], c: 0 };
                          for (var s = 0, l = "k" === e ? 2 : 5; s < l; s++)
                            o.insert.push({ pos: i + s, c: 0 });
                          return (o.pos = i + l), o;
                        }
                        if (
                          !0 ===
                          (o = n
                            ? new RegExp(
                                "[0-9" + b.escapeRegex(a.groupSeparator) + "]"
                              ).test(e)
                          ...
                          if (
                            ...
                            var u = t.buffer.join(""),
                              f = (u = (u = u.replace(
                                ...
                                new RegExp(
                                  b.escapeRegex(a.negationSymbol.back) + "$"
                                ),
                                ""
                              )).split(a.radixPoint);
                            1 < f.length &&
                              ...
                              (u = f[0] + a.radixPoint + f[1] || "");
                            var c = t._buffer.join("");
                            for (
                              u === a.radixPoint && (u = c);
                              null === u.match(b.escapeRegex(c) + "$");

                            )
                              c = c.slice(1);
                            o =
                              void 0 ===
                              (u = (u = u.replace(c, "")).split(""))[i]
                                ? { pos: i, remove: i }
                                : { pos: i };
                          }
                        } else
                    ...
                    ":": {
                      validator: function (e, t, i, n, a) {
                        ...
                        return (
                          o &&
                            t.validPositions[i] &&
                            t.validPositions[i].match.placeholder ===
                              a.radixPoint &&
                            (o = { caret: i + 1 }),
                          o
                        );
                  ...
                  onUnMask: function (e, t, i) {
                    ...
                    return (
                      (n = (n = n.replace(i.suffix, "")).replace(
                        new RegExp(b.escapeRegex(i.groupSeparator), "g"),
                        ""
                      )),
                      ...
                      i.unmaskAsNumber
                        ? ("" !== i.radixPoint &&
                            ...
                            (n = n.replace(
                              b.escapeRegex.call(this, i.radixPoint),
                              "."
                            )),
                          (n = (n = n.replace(
                            new RegExp(
                              "^" + b.escapeRegex(i.negationSymbol.front)
                            ),
                            "-"
                          )).replace(
                            new RegExp(
                              b.escapeRegex(i.negationSymbol.back) + "$"
                            ),
                            ""
                          )),
                          Number(n))
                  ...
                  isComplete: function (e, t) {
                    ...
                    return (
                      (i = (i = (i = (i = (i = i.replace(
                        new RegExp("^" + b.escapeRegex(t.negationSymbol.front)),
                        "-"
                      )).replace(
                        new RegExp(b.escapeRegex(t.negationSymbol.back) + "$"),
                        ""
                      )).replace(t.prefix, "")).replace(t.suffix, "")).replace(
                        new RegExp(
                          b.escapeRegex(t.groupSeparator) + "([0-9]{3})",
                          "g"
                        ),
                        "$1"
                      )),
                      "," === t.radixPoint &&
                        (i = i.replace(b.escapeRegex(t.radixPoint), ".")),
                      isFinite(i)
                    );
                  },
                    ...
                    return (
                      "" !== i &&
                        ...
                        "" !== r &&
                          ((o = Math.pow(10, s || 1)),
                          isFinite(t.digits) &&
                            ((s = parseInt(t.digits)), (o = Math.pow(10, s))),
                          (e = e.replace(b.escapeRegex(i), ".")),
                          isFinite(e) &&
                            (e = Math.round(parseFloat(e) * o) / o),
                          (e = e.toString().replace(".", i)))),
                      0 === t.digits &&
                        -1 !== e.indexOf(b.escapeRegex(i)) &&
                        (e = e.substring(0, e.indexOf(b.escapeRegex(i)))),
                      (function (e, t, i) {
                        if (0 < t) {
                          var n = x.inArray(i.radixPoint, e);
                          -1 === n &&
            ...
            if (a.fn.inputmask === undefined) {
              a.fn.inputmask = function (e, t) {
                ...
                if (typeof e === "string") {
                  ...
                  (typeof e === "undefined" ? "undefined" : o(e)) == "object"
                ) {
                  i = new r(e);
